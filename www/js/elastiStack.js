...
;( function( window ) {
	...
	ElastiStack.prototype._setStackStyle = function() {
		...
		if( item2 ) {
			...
			setTransformStyle( item2, is3d ? 'translate3d(0,-45px,-60px)' : 'translate(0,0)' );
		}

		if( item3 ) {
			item3.style.opacity = 1;
			item3.style.zIndex = 2;
			setTransformStyle( item3, is3d ? 'translate3d(0,-90px,-120px)' : 'translate(0,0)' );
		}
	};
	...
	ElastiStack.prototype._moveAway = function( instance ) {
		...
		var self = this,
			onEndTransFn = function() {
				...
				// reset first item
				setTransformStyle( instance.element, is3d ? 'translate3d(0,-135px,-180px)' : 'translate(0,0,0)' );
